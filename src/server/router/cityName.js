...
router.post('/create', (req, res, next) => {
	...
	cities = [
      ...
      {"city": "Amherst Center", "state": "MA"},
      {"city": "Amityville", "state": "NY"},
      {"city": "Ammon", "state": "ID"},
      {"city": "Amory", "state": "MS"},
      {"city": "Amsterdam", "state": "NY"},
      {"city": "Anaconda-Deer Lodge County", "state": "MT"},
    ...
    {"city": "Barclay-Kingston", "state": "NJ"},
    {"city": "Bardstown", "state": "KY"},
    {"city": "Barnhart", "state": "MO"},
    {"city": "Barnstable Town", "state": "MA"},
    {"city": "Barre", "state": "VT"},
    {"city": "Barre", "state": "VT"},
    ...
    {"city": "Baywood-Los Osos", "state": "CA"},
    ...
    {"city": "Berkeley Heights", "state": "NJ"},
    ...
    {"city": "Bloomfield Township", "state": "MI"},
    ...
    {"city": "Brownsville-Bawcomville", "state": "LA"},
    ...
    {"city": "Camp Pendleton North", "state": "CA"},
    ...
    {"city": "Collier Manor-Cresthaven", "state": "FL	"},
    ...
    {"city": "Cottonwood-Verde Village", "state": "AZ"},
    ...
    {"city": "Cross Lanes", "state": "West VA"},
    ...
    {"city": "East Bridgewater", "state": "MA"},
    ...
    {"city": "Elkhorn", "state": "NE"},
    {"city": "Elkhorn", "state": "WI"},
    {"city": "Elkins", "state": "West VA"},
    {"city": "Elko", "state": "NV"},
    ...
    {"city": "FL	 City", "state": "FL	"},
    {"city": "FL	 Ridge", "state": "FL	"},
    ...
    {"city": "Greater Landover", "state": "MD"},
    {"city": "Greater Northdale", "state": "FL	"},
    {"city": "Greater Sun Center", "state": "FL	"},
    ...
    {"city": "HIan Gardens", "state": "CA"},
    {"city": "HIan Paradise Park", "state": "HI"},
    ...
    {"city": "Lakes", "state": "AK"},
    {"city": "Lakes by the Bay", "state": "FL	"},
    ...
    {"city": "Lemay", "state": "MO"},
    {"city": "Lemmon Valley-Golden Valley", "state": "NV"},
    ...
    {"city": "Little Cottonwood Creek Valley", "state": "UT"},
    ...
    {"city": "Martinsburg", "state": "West VA"},
    {"city": "Martinsville", "state": "VA"},
    {"city": "Martinsville", "state": "IN"},
    {"city": "MD City", "state": "MD"},
    {"city": "MD Heights", "state": "MO"},
    ...
    {"city": "Moundsville", "state": "West VA"},
    ...
    {"city": "North Attleborough", "state": "MA"},
    ...
    {"city": "North Brunswick Township", "state": "NJ"},
    {"city": "North Caldwell", "state": "NJ"},
    {"city": "North Canton", "state": "OH"},
    {"city": "North Castle", "state": "NY"},
    ...
    {"city": "North Marysville", "state": "WA"},
    ...
    {"city": "Paine Field-Lake Stickney", "state": "WA"},
    ...
    {"city": "Parkersburg", "state": "West VA"},
    ...
    {"city": "Saginaw Township North", "state": "MI"},
    ...
    {"city": "Seneca Falls", "state": "NY"},
    {"city": "Setauket-East Setauket", "state": "NY"},
    ...
    {"city": "South Charleston", "state": "West VA"},
    ...
    {"city": "Succasunna-Kenvil", "state": "NJ"},
    ...
    {"city": "Teays Valley", "state": "West VA"},
    ...
    {"city": "Wakefield", "state": "MA"},
    {"city": "Wakefield-Peacedale", "state": "RI"},
    ...
    {"city": "Wallkill", "state": "NY"},
    {"city": "Walnut", "state": "CA"},
    {"city": "Walnut Creek", "state": "CA"},
    {"city": "Walnut Grove", "state": "WA"},
    ...
    {"city": "WA", "state": "WI"},
    {"city": "WA", "state": "WA"},
    {"city": "WA Terrace", "state": "UT"},
    {"city": "WA Township", "state": "NJ"},
    ...
    {"city": "West Boylston", "state": "MA"},
    {"city": "West Bridgewater", "state": "MA"},
    {"city": "West Caldwell", "state": "NJ"},
    ...
    {"city": "Westgate-Belvedere Homes", "state": "FL	"},
    ...
    {"city": "Winslow", "state": "ME"},
    {"city": "Winslow", "state": "ME"},
    {"city": "Winslow", "state": "AZ"},
    {"city": "Winsted", "state": "CT"},
    {"city": "Winston", "state": "FL	"},
...
router.post('/edit', (req, res, next) => {
	...
	// 	color:/black/
	// };
	CityName.updateOne(conditions, cityName, (err) => {
		if (err) return console.log(err)
		res.json({
			status: 200
		})
